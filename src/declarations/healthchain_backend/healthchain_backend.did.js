export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'getDoctorById' : IDL.Func([IDL.Text], [IDL.Opt(ProfileData)], []),
    'getDoctorMetaDataById' : IDL.Func(
        [IDL.Text],
        [IDL.Opt(DoctorMetaData)],
        [],
      ),
    'getPatientById' : IDL.Func([IDL.Text], [IDL.Opt(ProfileData)], []),
    'readAllAppointments' : IDL.Func([], [IDL.Vec(Appointment)], ['query']),
    'readDepartments' : IDL.Func([], [IDL.Vec(IDL.Text)], ['query']),
    'readDoctorAppointments' : IDL.Func([], [IDL.Vec(Appointment)], []),
    'readDoctors' : IDL.Func([], [IDL.Vec(ProfileData)], []),
    ...
    'readPatientAppointments' : IDL.Func([], [IDL.Vec(Appointment)], []),
    'readPatients' : IDL.Func([], [IDL.Vec(ProfileData)], []),
